...
public class JenkinsConfig {
  ...
  public String getJenkinsRootUrl() throws LoadConfigFailureException {
    String jenkinsAutoLoginUrl = System.getenv("WEB_JENKINS_AUTO_LOGIN_URL");
    System.out.println("WEB_JENKINS_AUTO_LOGIN_URL: " + jenkinsAutoLoginUrl);
    if (jenkinsAutoLoginUrl != null && !jenkinsAutoLoginUrl.equals("")) {
      return jenkinsAutoLoginUrl;
    }
    if (props != null) {
